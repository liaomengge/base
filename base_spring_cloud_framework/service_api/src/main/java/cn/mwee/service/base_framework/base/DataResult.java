...
import cn.mwee.service.base_framework.base.code.IResultCode;
import lombok.Getter;
import lombok.Setter;

import java.io.Serializable;

import static cn.mwee.service.base_framework.base.code.SystemResultCode.SERVER_ERROR;
import static cn.mwee.service.base_framework.base.code.SystemResultCode.SUCCESS;
...
public class DataResult<T> implements Serializable {
    ...
    public DataResult(boolean success) {
        ...
        requestId = MwTraceLogUtil.get();
    }

    public DataResult(T data) {
        this(true);
        this.data = data;
        sysErrCode = SUCCESS.getCode();
        sysErrDesc = SUCCESS.getDescription();
    }
    ...
    public static <T> DataResult<T> success() {
        ...
        dataResult.setSysErrCode(SUCCESS.getCode());
        dataResult.setSysErrDesc(SUCCESS.getDescription());
        return dataResult;
    }
    ...
    public static <T> DataResult<T> fail() {
        return fail(SERVER_ERROR.getDescription());
    }

    public static <T> DataResult<T> fail(String sysErrDesc) {
        return fail(SERVER_ERROR, sysErrDesc);
    }
