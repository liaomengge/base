...
import static cn.mwee.service.base_framework.base.code.SystemResultCode.SIGN_ERROR;
...
public class SignFilter extends AbstractFilter {
    ...
    public Object doFilter(ProceedingJoinPoint joinPoint, FilterChain chain) throws Throwable {
        ...
        restResponse.setErrNo(SIGN_ERROR.getCode());
        restResponse.setErrMsg(SIGN_ERROR.getDescription());
