 ...
 */
public class MwThreadPoolExecutorUtil {

    private static final Logger logger = MwLogger.getInstance(MwThreadPoolExecutorUtil.class);
    ...
    public static ThreadPoolExecutor buildSingleThreadPool(String threadName, long keepAliveTime, TimeUnit unit,
                                                           BlockingQueue<Runnable> workQueue,
                                                           RejectedExecutionHandler handler) {
    ...
    public static ThreadPoolExecutor buildSingleThreadPool(String threadName, BlockingQueue<Runnable> workQueue,
                                                           RejectedExecutionHandler handler) {
        return buildSingleThreadPool(threadName, 0L, TimeUnit.MILLISECONDS, workQueue, handler);
    }

    public static ThreadPoolExecutor buildSingleThreadPool(String threadName, int queueCapacity,
                                                           RejectedExecutionHandler handler) {
    ...
    public static ThreadPoolExecutor buildSimpleThreadPool(String threadName, int queueCapacity,
                                                           RejectedExecutionHandler handler) {
    ...
    public static ThreadPoolExecutor buildCpuCoreThreadPool(String threadName, int queueCapacity,
                                                            RejectedExecutionHandler handler) {
    ...
    public static void registerShutdownHook(ThreadPoolExecutor threadPoolExecutor) {
     ...
     */
    public static void registerShutdownHook(ThreadPoolExecutor threadPoolExecutor, int awaitTerminationSeconds,
                                            int checkInterval) {
