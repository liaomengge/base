package cn.mwee.base_common.helper.mybatis.transaction.callback;
...
public class TransactionCallbackHelper {
    ...
    @Around("@annotation(cn.mwee.base_common.helper.mybatis.transaction.callback.TransactionCallBack)")
