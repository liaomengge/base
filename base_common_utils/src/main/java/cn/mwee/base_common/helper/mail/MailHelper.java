package cn.mwee.base_common.helper.mail;

import cn.mwee.base_common.helper.mail.body.AttachmentMailBody;
import cn.mwee.base_common.helper.mail.body.AttachmentMailBody.AttachmentMailFile;
import cn.mwee.base_common.helper.mail.body.HtmlMailBody;
import cn.mwee.base_common.helper.mail.body.InlineMailBody;
import cn.mwee.base_common.helper.mail.body.InlineMailBody.InlineMailFile;
import cn.mwee.base_common.helper.mail.body.TextMailBody;
import cn.mwee.base_common.support.misc.Symbols;
    ...
    private void sendTo(String subject, InlineMailBody mailBody, String senderNickName,
        ...
        for (String to : toArr) {
            try {
                ...
                List<InlineMailFile> inlineMailFiles = mailBody.getInlineMailFiles();
                if (CollectionUtils.isNotEmpty(inlineMailFiles)) {
                    for (InlineMailFile inlineMailFile : inlineMailFiles) {
