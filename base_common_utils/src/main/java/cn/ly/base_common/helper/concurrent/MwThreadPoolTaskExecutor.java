...
@Getter
@Setter
public class MwThreadPoolTaskExecutor extends ThreadPoolTaskExecutor {

    private static final Logger logger = MwLogger.getInstance(MwThreadPoolTaskExecutor.class);
    ...
    public MwThreadPoolTaskExecutor(String threadName) {
