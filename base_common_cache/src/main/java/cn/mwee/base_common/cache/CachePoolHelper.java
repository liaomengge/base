...
import cn.mwee.base_common.cache.caffeine.CaffeineCacheManager;
import cn.mwee.base_common.cache.channel.Channel;
import cn.mwee.base_common.cache.consts.CacheConst;
import cn.mwee.base_common.cache.domain.CacheDomain;
import cn.mwee.base_common.cache.enums.NotifyTypeEnum;
import cn.mwee.base_common.cache.redis.RedisCache;
...
public class CachePoolHelper {
    ...
    private static final Logger logger = MwLogger.getInstance(CachePoolHelper.class);
    ...
    public <T> T getFromLevel1(String region, String key, Class<T> clazz) {
        ...
        return MwJsonUtil.fromJson(level1Json, clazz);
    }
    ...
    public <T> void setToLevel1(String region, String key, T value) {
        ...
        caffeineCacheManager.getCache(region).set(key, MwJsonUtil.toJson(value));
    }
    ...
    public <T> void setToLevel2(String key, T value) {
        ...
        redisCache.set(key, MwJsonUtil.toJson(value));
    }
    ...
    public <T> void setToLevel2(String key, T value, int expiredSeconds) {
        ...
        redisCache.set(key, MwJsonUtil.toJson(value), expiredSeconds);
    }
    ...
    public <T> void set(String region, String key, T value) {
        ...
        try {
            String json = MwJsonUtil.toJson(value);
    ...
    private void sendPubCmd(CacheDomain cacheDomain) {
        channel.doPubChannel(MwJsonUtil.toJson4Log(cacheDomain));
    }

    @PostConstruct
    private void init() {
        channel.doSubChannel(msg -> {
            CacheDomain cacheDomain = MwJsonUtil.fromJson(msg, CacheDomain.class);
