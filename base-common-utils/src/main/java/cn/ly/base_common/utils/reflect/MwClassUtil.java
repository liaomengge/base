...
public class MwClassUtil {
...

    {
        ...
        MwClassUtil.primitiveWrapperTypeMap.put(Double.class, Double.TYPE);
        MwClassUtil.primitiveWrapperTypeMap.put(Float.class, Float.TYPE);
        MwClassUtil.primitiveWrapperTypeMap.put(Integer.class, Integer.TYPE);
        MwClassUtil.primitiveWrapperTypeMap.put(Long.class, Long.TYPE);
    ...
    public Method getGetterMethod(Class<?> clazz, String propertyName) {
        ...
        if (method == null) {
            getterMethodName = MwClassUtil.IS_PREFIX + StringUtils.capitalize(propertyName);
            method = MwClassUtil.getAccessibleMethod(clazz, getterMethodName);
        }
        return method;
    }
    ...
    public Field getAccessibleField(Class clazz, String fieldName) {
        ...
        for (Class<?> superClass = clazz; superClass != Object.class; superClass = superClass.getSuperclass()) {
            try {
                ...
                MwClassUtil.makeAccessible(field);
                return field;
