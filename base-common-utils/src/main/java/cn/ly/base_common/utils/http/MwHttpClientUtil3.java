...
import cn.ly.base_common.utils.properties.MwConfigUtil;
 ...
 */
@UtilityClass
public class MwHttpClientUtil3 {

    private final Logger logger = MwLogger.getInstance(MwHttpClientUtil3.class);
