...
import com.github.liaomengge.base_common.multi.mybatis.druid.DruidConfiguration4;
...
import com.github.liaomengge.base_common.multi.mybatis.hikari.HikariConfiguration4;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "base.mybatis.four", name = "enabled", havingValue = "true")
@Import({DruidConfiguration4.class, HikariConfiguration4.class})
@ExtendMapperScan(basePackages = "${base.mybatis.four.basePackages}", sqlSessionFactoryRef = "fourSqlSessionFactory")
public class DynamicDataSourceConfiguration4 {

    @Bean("mybatisProperties4")
    @ConfigurationProperties(prefix = "base.mybatis.four")
    public MybatisProperties mybatisProperties4() {
        return new MybatisProperties();
    }

    @Bean("pageHelperProperties4")
    @ConfigurationProperties(prefix = "base.mybatis.four.pagehelper")
    public Properties pageHelperProperties4() {
        return new Properties();
    }

    @Bean("flowProperties4")
    @ConfigurationProperties(prefix = "base.mybatis.four.flow")
