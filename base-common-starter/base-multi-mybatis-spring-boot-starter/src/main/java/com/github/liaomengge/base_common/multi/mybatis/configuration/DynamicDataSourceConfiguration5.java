...
import com.github.liaomengge.base_common.multi.mybatis.druid.DruidConfiguration5;
...
import com.github.liaomengge.base_common.multi.mybatis.hikari.HikariConfiguration5;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "base.mybatis.five", name = "enabled", havingValue = "true")
@Import({DruidConfiguration5.class, HikariConfiguration5.class})
@ExtendMapperScan(basePackages = "${base.mybatis.five.basePackages}", sqlSessionFactoryRef = "fiveSqlSessionFactory")
public class DynamicDataSourceConfiguration5 {

    @Bean("mybatisProperties5")
    @ConfigurationProperties(prefix = "base.mybatis.five")
    public MybatisProperties mybatisProperties5() {
        return new MybatisProperties();
    }

    @Bean("pageHelperProperties5")
    @ConfigurationProperties(prefix = "base.mybatis.five.pagehelper")
    public Properties pageHelperProperties5() {
        return new Properties();
    }

    @Bean("flowProperties5")
    @ConfigurationProperties(prefix = "base.mybatis.five.flow")
    ...
    public DataSourceTransactionManager dataSourceTransactionManager(@Qualifier("fiveDynamicDataSource") DynamicDataSource dynamicDataSource) {
        ...
        MybatisProperties.TxProperties txProperties = this.mybatisProperties5().getTx();
