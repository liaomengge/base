...
import com.github.liaomengge.base_common.multi.mybatis.druid.DruidConfiguration3;
...
import com.github.liaomengge.base_common.multi.mybatis.hikari.HikariConfiguration3;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "base.mybatis.three", name = "enabled", havingValue = "true")
@Import({DruidConfiguration3.class, HikariConfiguration3.class})
@ExtendMapperScan(basePackages = "${base.mybatis.three.basePackages}", sqlSessionFactoryRef = "threeSqlSessionFactory")
public class DynamicDataSourceConfiguration3 {

    @Bean("mybatisProperties3")
    @ConfigurationProperties(prefix = "base.mybatis.three")
    public MybatisProperties mybatisProperties3() {
        return new MybatisProperties();
    }

    @Bean("pageHelperProperties3")
    @ConfigurationProperties(prefix = "base.mybatis.three.pagehelper")
    public Properties pageHelperProperties3() {
        return new Properties();
    }

    @Bean("flowProperties3")
    @ConfigurationProperties(prefix = "base.mybatis.three.flow")
