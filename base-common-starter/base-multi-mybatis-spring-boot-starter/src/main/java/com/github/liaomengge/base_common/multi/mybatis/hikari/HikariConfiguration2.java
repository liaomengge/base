package com.github.liaomengge.base_common.multi.mybatis.hikari;
...
@Configuration
public class HikariConfiguration2 {

    @Bean(name = "twoMasterDataSource", destroyMethod = "close")
    @Primary
    @ConfigurationProperties("base.mybatis.two.hikari.master")
    public HikariDataSource masterDataSource() {
        return DataSourceBuilder.create().type(HikariDataSource.class).build();
    }

    @Bean(name = "twoSlaveDataSource", destroyMethod = "close")
    @ConfigurationProperties("base.mybatis.two.hikari.slave")
