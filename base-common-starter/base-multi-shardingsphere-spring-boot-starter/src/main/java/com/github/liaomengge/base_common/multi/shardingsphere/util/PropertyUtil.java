package com.github.liaomengge.base_common.multi.shardingsphere.util;
...
public class PropertyUtil {
    ...
    public static boolean containPropertyPrefix(Environment environment, String prefix) {
        try {
            Map<String, Object> properties = (Map<String, Object>) (1 == springBootVersion ? v1(environment, prefix,
                    false) : v2(environment, prefix, Map.class));
    ...
    private static Object v1(Environment environment, String prefix, boolean handlePlaceholder) {
        ...
        Map<String, Object> dataSourceProps = (Map<String, Object>) getSubPropertiesMethod.invoke(resolverObject,
                prefixParam);
