package com.github.liaomengge.base_common.quartz.listener;

import com.github.liaomengge.base_common.quartz.QuartzProperties;
...
public class QuartzListener implements EnvironmentAware, ApplicationListener<EnvironmentChangeEvent>, Ordered {
    ...
    public void onApplicationEvent(EnvironmentChangeEvent event) {
        Optional<String> quartzChange = event.getKeys().stream()
                .filter(val -> StringUtils.startsWithIgnoreCase(val, "base.quartz")).findFirst();
    ...
    private Map<String, String> buildTriggerDetail() {
        ...
        QuartzProperties quartzProperties = LyBinderUtil.bind((ConfigurableEnvironment) environment, "base.quartz",
