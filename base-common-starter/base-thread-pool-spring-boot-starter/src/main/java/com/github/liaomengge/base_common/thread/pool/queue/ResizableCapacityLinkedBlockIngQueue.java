package com.github.liaomengge.base_common.thread.pool.queue;
...
public class ResizableCapacityLinkedBlockIngQueue<E> extends AbstractQueue<E>
    ...
    private static final long serialVersionUID = 2611468686857371250L;
    ...
    public void put(E e) throws InterruptedException {
        ...
        int c = -1;
        ResizableCapacityLinkedBlockIngQueue.Node<E> node = new ResizableCapacityLinkedBlockIngQueue.Node<>(e);
        ReentrantLock putLock = this.putLock;
    ...
    public Spliterator<E> spliterator() {
        return new ResizableCapacityLinkedBlockIngQueue.LBQSpliterator<>(this);
    }
