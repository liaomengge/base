 ...
 */
package com.github.liaomengge.base_common.base.mybatis.druid.stat;
...
public class DruidFilterConfiguration {
    ...
    private static final String FILTER_STAT_PREFIX = "base.mybatis.druid.filter.stat";
    private static final String FILTER_CONFIG_PREFIX = "base.mybatis.druid.filter.config";
    private static final String FILTER_ENCODING_PREFIX = "base.mybatis.druid.filter.encoding";
    private static final String FILTER_SLF4J_PREFIX = "base.mybatis.druid.filter.slf4j";
    private static final String FILTER_LOG4J_PREFIX = "base.mybatis.druid.filter.log4j";
    private static final String FILTER_LOG4J2_PREFIX = "base.mybatis.druid.filter.log4j2";
    private static final String FILTER_COMMONS_LOG_PREFIX = "base.mybatis.druid.filter.commons-log";
    private static final String FILTER_WALL_PREFIX = "base.mybatis.druid.filter.wall";
