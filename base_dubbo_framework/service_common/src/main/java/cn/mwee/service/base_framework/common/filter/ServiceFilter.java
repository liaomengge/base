...
public class ServiceFilter extends AbstractFilter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            if (Objects.isNull(result.getValue())) { //无返回,通常是发生了异常,被dubbo捕获了
                ...
                if (result instanceof RpcResult) {
                    ...
                    if (result.hasException()) {
                        ...
                        String errorCode = ErrorCodeEnum.SERVER_ERROR.getCode();
                        String errorDesc = ErrorCodeEnum.SERVER_ERROR.getDescription();
            ...
            //其它未知异常处理
            DataResult dataResult = new DataResult(ErrorCodeEnum.SERVER_ERROR.getCode(),
                    ErrorCodeEnum.SERVER_ERROR.getDescription());
            if (serviceConfig.isThrowException()) {
