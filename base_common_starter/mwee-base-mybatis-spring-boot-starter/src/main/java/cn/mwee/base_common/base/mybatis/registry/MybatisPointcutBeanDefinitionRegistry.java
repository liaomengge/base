package cn.mwee.base_common.base.mybatis.registry;

import cn.mwee.base_common.base.mybatis.aspect.MybatisPointcutAdvisor;
...
import static cn.mwee.base_common.base.mybatis.MybatisProperties.MappingProperties;
...
public class MybatisPointcutBeanDefinitionRegistry implements EnvironmentAware, BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        Map<String, MappingProperties> mappingJsonMap = MwJsonUtil.fromJson(mappingJson,
                new TypeReference<Map<String, MappingProperties>>() {
                });
