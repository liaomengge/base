...
import cn.mwee.base_common.quartz.QuartzProperties.JobInfo;
import cn.mwee.base_common.quartz.listener.QuartzListener;
import cn.mwee.base_common.quartz.registry.QuartzBeanRegistryConfiguration;
...
import static cn.mwee.base_common.quartz.registry.QuartzBeanDefinitionRegistry.getApplicationContext;
import static cn.mwee.base_common.quartz.registry.QuartzBeanDefinitionRegistry.getJobBeanMap;
...
public class QuartzAutoConfiguration {
    ...
    public List<CronTrigger> buildJobTrigger() {
        ...
        for (JobDetailImpl jobDetail : jobDetailList) {
            ...
            JobInfo jobInfo = this.quartzProperties.findClassName(jobDetail.getName());
    ...
    public List<JobDetailImpl> buildJobDetail() {
        ...
        List<JobInfo> jobInfoList = this.quartzProperties.getJobs();
