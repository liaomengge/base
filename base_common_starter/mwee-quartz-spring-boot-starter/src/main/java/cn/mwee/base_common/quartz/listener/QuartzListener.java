package cn.mwee.base_common.quartz.listener;

import cn.mwee.base_common.quartz.QuartzProperties;
import cn.mwee.base_common.quartz.QuartzProperties.JobInfo;
import cn.mwee.base_common.quartz.listener.util.TriggerUtil;
...
public class QuartzListener implements EnvironmentAware, ApplicationListener<EnvironmentChangeEvent>, Ordered {
    ...
    private Map<String, String> buildTriggerDetail() {
        ...
        Map<String, JobInfo> jobJsonMap = MwJsonUtil.fromJson(jobJson,
                new TypeReference<Map<String, JobInfo>>() {
                });
