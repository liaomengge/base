package cn.mwee.base_common.mq.rabbitmq.registry;

import cn.mwee.base_common.mq.rabbitmq.RabbitMQProperties.QueueProperties;
...
public class RabbitMQQueueConfigBeanDefinitionRegistry implements EnvironmentAware,
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        new RelaxedDataBinder(queuePropertiesMap, "mwee.mq.rabbitmq").bind(new PropertySourcesPropertyValues(propertySources));
