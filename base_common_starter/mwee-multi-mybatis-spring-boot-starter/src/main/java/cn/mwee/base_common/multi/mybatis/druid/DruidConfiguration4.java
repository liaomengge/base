package cn.mwee.base_common.multi.mybatis.druid;

import cn.mwee.base_common.multi.mybatis.druid.properties.DruidStatProperties;
import cn.mwee.base_common.multi.mybatis.druid.stat.DruidFilterConfiguration;
import cn.mwee.base_common.multi.mybatis.druid.stat.DruidStatViewServletConfiguration;
import cn.mwee.base_common.multi.mybatis.druid.stat.DruidWebStatFilterConfiguration;
import cn.mwee.base_common.multi.mybatis.druid.wrapper.DruidDataSourceBuilder;
...
public class DruidConfiguration4 {
    ...
    @ConfigurationProperties("mwee.mybatis.four.druid.slave")
