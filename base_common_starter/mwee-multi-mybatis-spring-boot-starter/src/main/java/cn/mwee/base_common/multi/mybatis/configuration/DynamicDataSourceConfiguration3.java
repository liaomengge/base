...
import cn.mwee.base_common.multi.mybatis.druid.DruidConfiguration3;
...
import cn.mwee.base_common.multi.mybatis.hikari.HikariConfiguration3;
...
public class DynamicDataSourceConfiguration3 {
    ...
    public DataSourceTransactionManager dataSourceTransactionManager(@Qualifier("threeDynamicDataSource") DynamicDataSource dynamicDataSource) {
        ...
        TxProperties txProperties = this.mybatisProperties3().getTx();
