package cn.mwee.base_common.dayu.sentinel.filter;

import cn.mwee.base_common.dayu.sentinel.SentinelProperties;
import cn.mwee.base_common.dayu.sentinel.SentinelProperties.FilterProperties;
...
public class SentinelWebConfiguration {
    ...
    public FilterRegistrationBean sentinelFilterRegistrationBean(SentinelFilter filter) {
        ...
        FilterProperties filterProperties = sentinelProperties.getFilter();
        String[] patterns = {"/*"};
